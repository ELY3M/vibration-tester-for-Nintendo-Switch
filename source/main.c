...
int main(int argc, char* argv[])
{
    ...
    {
        consoleClear();
        printf("-= Vibration Tester =-\n");		
        printf("Press PLUS to exit.\n");
        printf("Press R to start vibrating.\n");
        printf("Press L to stop vibrating.\n");		
        ...
        if (R_SUCCEEDED(rc) && (kDown & HidNpadButton_R))
        {
		...
		if(kDown & HidNpadButton_L)//Stop vibration for all devices.
        {
